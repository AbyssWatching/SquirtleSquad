...
const CardDetails = ({ card }) => {
  ...
  return (
    ...
    <button className="delete-button" onClick={handleClick}><i className="fa fa-trash-o"></i></button>
    <button className="delete-button update" onClick={updateCard}>Update</button>
    </div>
  )
}
